...
#define _COLOR_FG( a )           "38;5;" #a
#define _COLOR_FG_RGB( a, b, c ) "38;2;" #a
...
#define COLOR_FG( a )            printf( OCT _COLOR_FG( a ) "m" )
#define COLOR_BG( a )            printf( OCT _COLOR_BG( a ) "m" )
